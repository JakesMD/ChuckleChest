...
class CChestRepository {
  ...
  fetchUserInvitations({required String email}) => chestClient
      .fetchUserInvitations(email: email)
      .thenConvert(
  ...
  BobsJob<CChestUpdateException, BobsNothing> updateChest({
    ...
    required String name,
      ...
      .updateChestName(chestID: chestID, name: name)
      .thenConvert(
  ...
  fetchChestInvitations({required String chestID}) => chestClient
  ...
  BobsJob<CMembersFetchException, List<CMember>> fetchMembers({
    required String chestID,
      ...
      .fetchChestMembers(chestID: chestID)
      .thenConvert(
