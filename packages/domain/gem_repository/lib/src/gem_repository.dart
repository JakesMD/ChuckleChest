...
class CGemRepository {
  ...
  const CGemRepository({required this.gemClient, required this.platformClient});
  ...
  BobsJob<CGemShareTokenCreationException, String> createGemShareToken({
    ...
    required String gemID,
      ...
      .createGemShareToken(
        record: CGemShareTokensTableInsert(chestID: chestID, gemID: gemID),
      )
      .thenConvert(
